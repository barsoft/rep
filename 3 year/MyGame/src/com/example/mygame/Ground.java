...
public class Ground extends Distructable {
	...
	public static void loadTypes(Renderer r) {
		arr = new ArrayList<>();
		arr.add(new Ground("ground", 0, 0, r.blockWidth, r.blockHeight, new File("res/materials/ground.tga"),150,r));
		arr.add(new Ground("stone", 0, 0, r.blockWidth, r.blockHeight, new File("res/materials/stone.tga"),250, r));
		arr.add(new Ground("iron", 0, 0, r.blockWidth, r.blockHeight, new File("res/materials/iron.tga"),300, r));
		arr.add(new Ground("gold", 0, 0, r.blockWidth, r.blockHeight, new File("res/materials/gold.tga"),400,r));
		arr.add(new Ground("lead", 0, 0, r.blockWidth, r.blockHeight, new File("res/materials/lead.tga"),800,r));
	}
