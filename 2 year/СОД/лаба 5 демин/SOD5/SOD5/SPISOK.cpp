...
void Spisok::MainMenu(char *path,char *pathOut)
{
	bool end=false;
	char Key;
	do
	{
		...
		switch(Key)
		{
		case '1':InputConsole();	WaitForPress();break;
		case '2':clrscr;OutputConsole();	WaitForPress();break;
		case '3':InputFile(path);	WaitForPress();break;
		case '4':OutputFile(pathOut);	WaitForPress();break;
		case '5':
			clrscr;
			...
			switch(Key)
			{
			case '1':Sort();WaitForPress();break;
			case '2':Search();WaitForPress();break;
			case '3':	
				clrscr;
				...
				switch(Key)
				{
				case '1':DobavlElemVKonets();	WaitForPress();break;
				case '2':DobavlElemVNach();	WaitForPress();break;
				case '3':DobavlElemVPosiziy();	WaitForPress();break;
				}														
				break;
			case '4':Reverse();WaitForPress();break;
			case '5':Rakirovka();WaitForPress();break;
			case '6':CopyTo();WaitForPress();break;
			}
			break;
		case '6':
			clrscr;
			...
			switch(Key)
			{
			case '1':DeleteElem();	WaitForPress();break;
			case '2':ViborFirst();	WaitForPress();break;
			case '3':DeleteFirst();	WaitForPress();break;
			case '4':ViborAndDeleteFirst();	WaitForPress();break;
			case '5':ResetAll();	WaitForPress();break;
			case 27:break;
			}				
			break;
		case '7':
			...
			switch(Key)
			{
			case '1':ChangeAllFields();WaitForPress();break;
			case '2':ChangeVal();WaitForPress();break;
			case 27:break;
			}
			break;
		case '8':Sound();break;
