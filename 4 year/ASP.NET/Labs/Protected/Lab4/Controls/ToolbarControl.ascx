<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ToolbarControl.ascx.cs" Inherits="Labs.Lab4.ToolbarControl" %>
...
<div style="text-align: Left; height: 50px; padding: 5px; padding-right: 15px;">
    <table >
        <tr>
            <td>
                <asp:LinkButton ID="ShoppingCartLinkButton" CssClass="text" Style="font-size: small" runat="server" PostBackUrl="../ShoppingCartForm.aspx">
            ...
            <td>
                <asp:LinkButton ID="OrdersHistoryLinkButton" CssClass="text" Style="font-size: small" runat="server" PostBackUrl="../OrdersHistoryForm.aspx">
